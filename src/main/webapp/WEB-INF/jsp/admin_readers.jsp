        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${readers}" var="reader">
                <tr>
                    ...
                    <td><a href="reader_edit.html?readerId=<c:out value="${reader.readerId}"></c:out>"><button type="button" class="btn btn-info btn-xs">編集</button></a></td>
                    <td><a href="reader_delete.html?readerId=<c:out value="${reader.readerId}"></c:out>"><button type="button" class="btn btn-danger btn-xs">削除</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
